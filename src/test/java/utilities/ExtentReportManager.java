...
public class ExtentReportManager implements ITestListener
{
	...
	try {
		...
		email.setAuthenticator(new DefaultAuthenticator("vikasskakde@gmail.com", "password"));
		email.setSSLOnConnect(true);
		email.setFrom("vikasskakde@gmail.com"); //sender
		email.setSubject("Test Result");
		email.setMsg("Please find attached test report...");
		email.addTo("vikasskakde@gmail.com"); //Receiver
